...
<div class="admin">
 ...
 <div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" id="form1" class="form-x" action="<?php echo U('admin/front/edit');?>">
    ...
    <div class="form-group">
        ...
        <div class="field">
		  <select name="bid" class="input w50" >
		   ...
		   <?php if(is_array($business)): foreach($business as $key=>$b): ?><option value="<?php echo ($b['id']); ?>"  <?php if($data['bid']==$b['id']): ?>selected="selected"<?php endif; ?> ><?php echo ($b['businessname']); ?></option><?php endforeach; endif; ?>
            </select>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
         <input type="text" class="input w50" value="<?php echo ($data['comsume']); ?>" name="comsume" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
		  <select name="sid" class="input w50" >
            ...
            <?php if(is_array($supplie)): foreach($supplie as $key=>$s): ?><option value="<?php echo ($s['id']); ?>"   <?php if($data['bid']==$b['id']): ?>selected="selected"<?php endif; ?>  ><?php echo ($s['suppliename']); ?></option><?php endforeach; endif; ?>
            </select>
          <div class="tips"></div>
        </div>
      </div>
	 ...
	 <div class="form-group">
        ...
        <div class="field">
         <input type="text" class="input w50" value="<?php echo ($data['scount']); ?>" name="scount" data-validate="required:请输入耗材数量" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
         ...
         <a class="button border-main" href="<?php echo U('listData');?>">返回</a>
        </div>
      </div>
    </form>
