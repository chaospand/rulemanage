...
<form  method="get" action="/ruleManage/index.php/Admin/Business/index">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 业务列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
 <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('admin/business/add');?>"> 添加业务</a> </li>
        <li>搜索：</li>
		...
		<li>
          ...
          <button class="button border-main icon-search" type="submit">查询业务</button></li>
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	        ...
	        <td><div class="button-group"> <a class="button border-main" href="<?php echo U('admin/business/edit',array('id'=>$v['id']));?>"><span class="icon-edit"></span> 修改</a>
	         <a class="button border-red" href="javascript:if(confirm('确定删除？'))location='<?php echo U('admin/business/delete',array('id' => $v['id']));?>'"><span class="icon-trash-o"></span> 删除</a> </div></td>
