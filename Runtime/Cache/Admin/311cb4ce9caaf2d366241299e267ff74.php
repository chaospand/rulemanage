...
<div class="admin">
 ...
 <div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加业务</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/business/add');?>">
      <div class="form-group">
        <div class="label">
          <label>业务名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" placeholder="请输入业务名称" name="businessname" data-validate="required:请输入业务名称" />
          <div class="tips"></div>
        </div>
      </div>
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" placeholder="40%则输入40,最多两位小数" name="percent" data-validate="required: 输入返款比例 " />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="label">
         ...
         <div class="field ">
      	...
      	<input type="checkbox" name="supplie_ids[]" value="<?php echo ($vo["id"]); ?>"><label><?php echo ($vo["suppliename"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
      	<li>	
      	</ul>
      	</div>
	  </div>
