...
<div class="admin">
 ...
 <div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加耗材</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/supplie/add');?>">
      <div class="form-group">
        <div class="label">
          <label>耗材名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" placeholder="请输入耗材名称" name="suppliename" data-validate="required:请输入耗材名称" />
          <div class="tips"></div>
        </div>
      </div>
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" placeholder="请输入价格,最多两位小数" name="price" data-validate="required: 输入耗材价格 " />
          <div class="tips"></div>
        </div>
      </div>
