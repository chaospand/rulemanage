...
<form class="" action="<?php echo U('Admin/Nav/order');?>" method="post">
    ...
    <tbody>
	  <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
			...
			<td>
				<a href="<?php echo U('admin/authRule/editGroup',array('id' => $v['id']));?>" >修改</a>
				<a href="javascript:if(confirm('确定删除？'))location='<?php echo U('admin/authRule/deleteGroup',array('id' => $v['id']));?>'">删除</a>
				<a href="<?php echo U('admin/authRule/ruleGroup',array('id' => $v['id']));?>">分配权限</a>
			</td>	
