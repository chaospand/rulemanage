...
<div class="admin">
 ...
 <div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/authRule/edit');?>">
    ...
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo ($data['name']); ?>" name="name" data-validate="required: 输入模块/控制器/方法即可 例如 Admin/Nav/index" />
          <div class="tips"></div>
        </div>
      </div>
