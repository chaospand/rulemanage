...
<div class="admin">
 ...
 <div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改耗材</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/supplie/edit');?>">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" placeholder="请输入耗材名称" value="<?php echo ($data['suppliename']); ?>" name="suppliename" data-validate="required:请输入耗材名称" />
          <div class="tips"></div>
        </div>
      </div>
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" placeholder="输入耗材价格" value="<?php echo ($data['price']); ?>" name="price" data-validate="required: 输入耗材价格" />
          <div class="tips"></div>
        </div>
      </div>
