...
<div class="admin">
 ...
 <div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/nav/add');?>">
    ...
    <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="mca" data-validate="required: 输入模块/控制器/方法即可 例如 Admin/Nav/index" />
          <div class="tips"></div>
        </div>
      </div>
