...
<form method="get" action="/ruleManage/index.php/Admin/Supplie/index" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
 <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('admin/supplie/add');?>"> 添加耗材</a> </li>
        <li>搜索：</li>

        <li>
          <input type="text" value="<?php echo ($keywords); ?>" placeholder="请输入搜索关键字" name="keywords" class="input" style="width:250px; line-height:17px;display:inline-block" />
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	        ...
	        <td><div class="button-group"> <a class="button border-main" href="<?php echo U('admin/supplie/edit',array('id'=>$v['id']));?>"><span class="icon-edit"></span> 修改</a>
	         <a class="button border-red" href="javascript:if(confirm('确定删除？'))location='<?php echo U('admin/supplie/delete',array('id' => $v['id']));?>'"><span class="icon-trash-o"></span> 删除</a> </div></td>
