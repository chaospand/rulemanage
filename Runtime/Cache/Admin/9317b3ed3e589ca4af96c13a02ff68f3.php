...
<form class="" action="<?php echo U('Admin/Nav/order');?>" method="post">
    ...
    <tbody>
	  <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
			...
			<td>
				<a href="<?php echo U('admin/authRule/add',array('pid' => $v['id']));?>" >添加子权限菜单</a>
				<a href="<?php echo U('admin/authRule/edit',array('id' => $v['id']));?>">修改</a>
				<a href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/authRule/delete',array('id'=>$v['id']));?>'">删除</a>
			</td>	
