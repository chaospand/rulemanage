...
<div class="admin">
 ...
 <div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加前台用户</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('admin/frontUser/add');?>">
   		<div class="form-group">
	        <div class="label">
	          <label>前台用户名：</label>
	        </div>
	        <div class="field">
	          <input type="text" class="input w50" value="" name="front_name" data-validate="required:前台用户名" />
	          <div class="tips"></div>
	        </div>
      	</div>
      	<div class="form-group">
	        ...
	        <div class="field">
	          <input type="password" class="input w50" value="" name="password" data-validate="required:密码不能为空" />
	          <div class="tips"></div>
	        </div>
      	</div>
